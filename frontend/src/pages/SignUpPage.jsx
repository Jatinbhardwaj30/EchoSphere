...
const SignUpPage = () => {
  ...
  // Using custom hook for signup mutation
  ...
  return (
    <div className=" h-screen flex items-center justify-center p-4 sm:p-6 md:p-8" data-theme="forest">
      ...
      <div className="mb-4 flex items-center justify-start gap-2">
        ...
        to-secondary tracking-wider">EchoSphere</span>
      </div>
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="text-sm opacity-70">
                Join us to explore the world of EchoSphere. Please fill in your details below.  
              </p>
            </div>
      ...
      <div className="max-w-md p-8">
        ...
        <div className="text-center space-y-3 mt-6">
          ...
          <p className="opacity-70">
            Join EchoSphere to find language partners, practice speaking, and immerse yourself in new cultures.
          </p>
        </div>
      </div>
      </div>
